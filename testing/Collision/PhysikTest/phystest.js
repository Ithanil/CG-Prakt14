...
//	var vector1 = new THREE.Vector3(3., 0.5, -0.0);
	var vector1 = new THREE.Vector3(physobjs[1].refpos.x, physobjs[1].refpos.y, physobjs[1].refpos.z);
	var vector2 = new THREE.Vector3(3., 0.0, -0.0);

	var ray = new THREE.Raycaster(physobjs[1].refpos , vector2.normalize());
	var	collision = ray.intersectObjects([physobjs[1].geometry]);
	
	var arrow = new THREE.ArrowHelper(vector1,vector2,2, 0x29A3CC,3.5,0.5);

	scene.add(arrow);
	
	console.log( physobjs[1].refpos.x);
	console.log( physobjs[1].refpos.y);
	console.log( physobjs[1].refpos.z);
