...
////////////
	...
	var vector1 = new THREE.Vector3(1.0,0.5,-6.5);
	var vector2 = new THREE.Vector3(0.0,0.0,0.0);
	
	var ray = new THREE.Raycaster(vector1 , vector2.normalize());
	var	collision = ray.intersectObjects(physobjs);
